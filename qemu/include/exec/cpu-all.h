...
/* Set if the slow path must be used; more flags are in CPUTLBEntryFull. */
...
/* Flags stored in CPUTLBEntryFull.slow_flags[]. */
#define TLB_BSWAP           (1 << 0)
#define TLB_UC_HOOK         (1 << 1)
#define TLB_SLOW_FLAGS_MASK (TLB_BSWAP | TLB_UC_HOOK)
