...
DEF_HELPER_FLAGS_2(exit_request, TCG_CALL_NO_WG, noreturn, ptr, i32)
DEF_HELPER_2(check_exit_request, void, ptr, i32)
DEF_HELPER_4(check_counted_entry, void, ptr, i32, ptr, i32)
DEF_HELPER_4(uc_tracecode_single, void, ptr, i32, ptr, i64)
