...
static bool tcg_out_qemu_ld_slow_path(TCGContext *s, TCGLabelQemuLdst *lb)
{
    ...
    const int type = R_AARCH64_CONDBR19;
                           ...
                           const TCGArg *args, const int *const_args)
{
    ...
    case INDEX_op_shli_vec:
        if (is_scalar) {
            ...
            tcg_out_insn(s, 3614, SHL, is_q, a0, a1,
                         a2 + (8 << vece));
        }
        break;
    case INDEX_op_shri_vec:
        if (is_scalar) {
            ...
            tcg_out_insn(s, 3614, USHR, is_q, a0, a1,
                         (16 << vece) - a2);
        }
        break;
    case INDEX_op_sari_vec:
        if (is_scalar) {
            ...
            tcg_out_insn(s, 3614, SSHR, is_q, a0, a1,
                         (16 << vece) - a2);
        }
        break;
    case INDEX_op_aa64_sli_vec:
        if (is_scalar) {
            ...
            tcg_out_insn(s, 3614, SLI, is_q, a0, a2,
                         args[3] + (8 << vece));
        }
        break;
            ...
            if (cond == TCG_COND_NE) {
                if (const_args[2]) {
                    if (is_scalar) {
                        ...
                        tcg_out_insn(s, 3616, CMTST, is_q, vece,
                                     a0, a1, a1);
                    }
                } else {
                    if (is_scalar) {
                        ...
                        tcg_out_insn(s, 3616, CMEQ, is_q, vece,
                                     a0, a1, a2);
                    }
